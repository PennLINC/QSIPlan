...
Renders a compiled :class:`~qsiplan.plan.ExecutionPlan` as a flow
...
hover details. Shared by the group report (:mod:`qsiplan.interactive`)
...
def plan_payload(grouping, plan) -> dict:
    ...
    from ..report import drbuddi_channels, plan_step_records
